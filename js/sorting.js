...
(function () {
  window.initSorting = function () {
    ...
    filterBtns.discussedBtn.addEventListener('click', showDiscussedPhotos);
    filterBtns.newBtn.addEventListener('click', showNewPhotos);
    filterBtns.popularBtn.addEventListener('click', showPopularPhotos);
